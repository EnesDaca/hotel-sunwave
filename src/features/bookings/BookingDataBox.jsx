...
import { LuDoorOpen, LuCheckCircle } from "react-icons/lu";
  ...
  return (
    <StyledBookingDataBox>
      ...
      <Section>
        ...
        <DataItem icon={<LuCheckCircle />} label="Breakfast included?">
          {hasBreakfast ? "Yes" : "No"}
        </DataItem>

        <Price $isPaid={isPaid}>
          <DataItem icon={<HiOutlineCurrencyEuro />} label={`Total price`}>
